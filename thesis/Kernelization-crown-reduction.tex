...
\par{
  ...
  \begin{definition}
    ...
    \end{enumerate}
  \end{definition}
  Możliwość identyfikacji struktury $(I, N(I))$ zmniejszającej zaangażowanie w grafie $G=(V, E)$ jest ważna ze względu na to, że każdy podzbiór $C=N(I)\cupC^\prime$, gdzie $C^\prime$ stanowi optymalne pokrycie wierzchołkowe dla grafu $G[V \setminus (I\cup N(I))]$ stanowi optymalne pokrycie wierzchołkowe grafu $G$.
