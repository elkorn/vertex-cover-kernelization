...
\par{
  ...
  pewnej obliczalnej funkcji $f --- ~praktyce będącej zazwyczaj funkcją 
...
\par{
  ...
  Mianem pokrycia wierzchołkowego określa się zbiór wierzchołków $C
...
\par{
  ...
  \begin{bproof}
    ...
    Zaobserwować należy, że bez względu na ostateczną postać rozwiązania zadanego problemu, algorytm konsekwentnie zmniejsza rozmiar parametru poszukiwanego częściowego pokrycia.
