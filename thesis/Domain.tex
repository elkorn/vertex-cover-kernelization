...
\par{
  Problemy klasy $\mathcal{FPT}$ są rozwiązywalne w~czasie $f(k)\dot n^{O(1)}$ --- gdzie $n$ stanowi rozmiar danych wejściowych, a $k$ parametr ograniczający w pewien sposób parametry wyniku poszukiwań --- dla pewnej obliczalnej funkcji $f$.
