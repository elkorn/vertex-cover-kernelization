  ...
  \begin{algorithm}
    ...
    \begin{algorithmic}[1]
      \Function{C}{$G$, $k$}
        ...
        \If {$E=\emptyset$}
          \Return{true}\Comment{Odnaleziono pokr. wierzch. o~liczebności $\leq k$}
        \EndIf
        \If {$k=0$}
