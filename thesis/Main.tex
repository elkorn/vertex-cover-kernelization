...
\newtheorem{theorem}{\parindent=0pt{\bf Twierdzenie}}[section]
\newtheorem{property}{\parindent=0pt{\bf Własność}}[section]
\newtheorem{lemma}{\parindent=0pt{\bf Lemat}}[section]
\newtheorem{corollary}{\parindent=0pt{\bf Wniosek}}[section]
\newtheorem{definition}{\parindent=0pt{\bf Definicja}}
\newtheorem{proposition}{\parindent=0pt{\bf Założenie}}[section]
\newtheorem{conjecture}{\parindent=0pt{\bf Przypuszczenie}}[section]
\newtheorem*{nt*}{\parindent=0pt{\bf Neumhauser-Trotter}}

\newenvironment{proof}{\parindent=0pt{\bf Dowód. }}{\begin{flushright}$\square$\end{flushright}}
