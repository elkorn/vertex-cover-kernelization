...
\usepackage{cite}
\usepackage{listings}
\lstset{language={Go},inputencoding=latin2}
...
\newtheorem{definition}{\parindent=0pt{\textbf{Definicja}}}
...
\newtheorem{nt}{\parindent=0pt{\textbf{Neumhauser-Trotter}}}
\newtheorem*{konig*}{\parindent=0pt{\textbf{K\"onig}}}
\newtheorem{note}{\parindent=0pt{\textbf{Uwaga}}}[chapter]
\newtheorem*{weakduality*}{\parindent=0pt{\textbf{Twierdzenie o~słabej dualności}}}
\newtheorem*{strongduality*}{\parindent=0pt{\textbf{Twierdzenie o~silnej dualności}}}
